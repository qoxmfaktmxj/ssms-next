...
import { createDevelopManagement } from "@/server/data/develop-management-store";
...
const schema = z.object({
  ...
  requestSeq: z.number().int().nullable().optional(),
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    await saveSystemLog({
      ...
      actionType: "DEVELOP_MANAGEMENT_INSERT",
